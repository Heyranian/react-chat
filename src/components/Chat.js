      ...
      <div className="p-2 border-b flex items-center">
        <div className="flex gap-1">
          ...
          <svg width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path className="stroke-yellow-500" d="M12 8L12 13" stroke-width="2" stroke-linecap="round"/>
            <path className="stroke-yellow-500" d="M12 16V15.9888"stroke-width="2" stroke-linecap="round"/>
            <path className="stroke-yellow-500" d="M3 12C3 4.5885 4.5885 3 12 3C19.4115 3 21 4.5885 21 12C21 19.4115 19.4115 21 12 21C4.5885 21 3 19.4115 3 12Z" stroke-width="2"/>
          </svg>
          </div>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M15.5 7.83008L15.6716 8.00165C17.0049 9.33498 17.6716 10.0017 17.6716 10.8301C17.6716 11.6585 17.0049 12.3252 15.6716 13.6585L15.5 13.8301" stroke="white" stroke-width="1.5" stroke-linecap="round"/>
                        <path d="M13.2939 6L11.9998 10.8296L10.7058 15.6593" stroke="white" stroke-width="1.5" stroke-linecap="round"/>
                        <path d="M8.49994 7.83008L8.32837 8.00165C6.99504 9.33498 6.32837 10.0017 6.32837 10.8301C6.32837 11.6585 6.99504 12.3252 8.32837 13.6585L8.49994 13.8301" stroke="white" stroke-width="1.5" stroke-linecap="round"/>
                      </svg>
                    }
